...
add_component!(vms, TanhSpring("VLF pos error"; max_force=0.0, stiffness=10.0); id="VLF spring")
add_component!(vms, LinearDamper(0.0, "VLF pos error"); id="VLF damper")
add_component!(vms, TanhSpring("VRF pos error"; max_force=0.0, stiffness=10.0); id="VRF spring")
add_component!(vms, LinearDamper(0.0, "VRF pos error"); id="VRF damper")
add_component!(vms, TanhSpring("VHB pos error"; max_force=0.0, stiffness=10.0); id="VHB spring")
add_component!(vms, LinearDamper(0.0, "VHB pos error"); id="VHB damper")
...
function f_control(cache, target_positions, t, setup_ret, extra)
    ...
    print(configuration(cache, VMHandBase_coord_id))
    print("\n")
